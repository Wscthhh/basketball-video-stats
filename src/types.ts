...
export interface EventRecord { id: string; clipId?: string; seconds?: number; time?: string; type: EventType | string; shotType?: ShotType | null; shotTypeConfidence?: number; shotTypeSource?: string | null; courtX?: number | null; courtY?: number | null; homographyConfidence?: number; releaseFrame?: number | null; description?: string; playerId?: string | null; teamId?: string | null; status: EventStatus; points?: number | null; confidence?: number; confirmedBy?: string | null; confirmationRule?: string | null; highlightStart?: number | null; highlightEnd?: number | null }
