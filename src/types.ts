...
export interface Clip { id: string; name: string; sequence?: number; durationSeconds?: number; duration?: number; status?: string; confidence?: number; createdAt?: string; sizeBytes?: number; previewUrl?: string }
export interface Player { id: string; name: string; displayName?: string; number?: string; code?: string; teamId?: string | null; team?: 'home' | 'away'; identityType?: string; color?: string | null; confidence?: number; tracks?: number; tracksCount?: number; status?: string }
export interface EventRecord { id: string; clipId?: string; seconds?: number; time?: string; type: EventType | string; shotType?: ShotType | null; shotTypeConfidence?: number; shotTypeSource?: string | null; courtX?: number | null; courtY?: number | null; homographyConfidence?: number; releaseFrame?: number | null; description?: string; playerId?: string | null; teamId?: string | null; status: EventStatus; points?: number | null; confidence?: number; highlightStart?: number | null; highlightEnd?: number | null }
...
export interface Health { analyzer?: { ready?: boolean; mode?: string; models?: Record<string, { ready?: boolean; path?: string; task?: string; classes?: string[]; error?: string }> }; [key: string]: unknown }
