...
export interface Player { id: string; name: string; displayName?: string; number?: string | null; numberConfidence?: number; numberSource?: string | null; numberCandidates?: Array<{ number: string; votes: number; confidence: number }>; code?: string; teamId?: string | null; team?: 'home' | 'away'; identityType?: string; color?: string | null; confidence?: number; tracks?: number; tracksCount?: number; status?: string }
